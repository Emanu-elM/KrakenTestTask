...
public class PricesPage extends Form {
    public PricesPage() {
        super(By.xpath("//div[@id = 'kraken-tabpanel-0']"), "Top screen panel");
        getElementFactory().getLabel(By.xpath("//div[@id = 'kraken-tabpanel-0']"), "Top screen panel").state().waitForDisplayed();
    }
